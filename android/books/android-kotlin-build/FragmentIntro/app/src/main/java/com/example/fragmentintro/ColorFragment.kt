...
import com.example.fragmentintro.databinding.FragmentColorBinding
...
class ColorFragment : Fragment() {
    ...
    private fun setupEvents() {
        binding.redButton.setOnClickListener {
            binding.helloWorld.setTextColor(Color.RED)
        }
        binding.greenButton.setOnClickListener {
            binding.helloWorld.setTextColor(Color.GREEN)
        }
        binding.blueButton.setOnClickListener {
            binding.helloWorld.setTextColor(Color.BLUE)
        }
    }
