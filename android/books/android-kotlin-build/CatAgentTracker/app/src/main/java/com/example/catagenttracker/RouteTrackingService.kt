...
class RouteTrackingService : Service() {
    ...
    private fun getPendingIntent(): PendingIntent {
        ...
        val flag = PendingIntent.FLAG_UPDATE_CURRENT or FLAG_IMMUTABLE
    ...
    private fun getNotificationBuilder(pendingIntent: PendingIntent, channelId: String) =
        NotificationCompat.Builder(this, channelId).setContentTitle("Agent approaching destination")
            .setContentText("Agent dispatched").setSmallIcon(R.drawable.ic_launcher_foreground)
            .setContentIntent(pendingIntent).setTicker("Agent dispatched, tracking movement")
            .setOngoing(true)
    ...
    private fun trackToDestination(notificationBuilder: NotificationCompat.Builder) {
        ...
        for (i in 10 downTo 0) {
            Thread.sleep(1000L)
            notificationBuilder.setContentText("$i seconds to destination").setSilent(true)
    ...
    companion object {
        ...
        val trackingCompletion: LiveData<String> get() = mutableTrackingCompletion
    }
}